                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between bg-green-50 rounded-lg px-3 py-2">
                        <div className="min-w-0">
                          <p className="text-xs text-green-700 font-medium">Faol</p>
                          <p className="text-xs text-gray-700 font-mono truncate">{talaba.login}</p>
                        </div>
                        <button
                          onClick={() => navigator.clipboard.writeText(talaba.login ?? "")}
                          title="Nusxa olish"
                          className="ml-2 flex-shrink-0 text-gray-400 hover:text-brand-600 transition-colors"
                        >
                      ...
                      <button
                        ...
                        className="w-full py-1.5 px-3 text-xs font-medium text-gray-600 border border-gray-200 rounded-lg hover:border-brand-400 hover:text-brand-600 transition-colors"
                      >
                        Parolni yangilash
                      </button>
                    </div>
